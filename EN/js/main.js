(function($) {
  ...
  function displayTestimonies() {
    ...
    // Check if testimonies array is not empty
    if (testimonies.length > 0) {
      ...
      console.error("Testimonies array is empty.");
    }
  }
...
function changeLanguage(lang) {
  ...
  if (lang === 'en') {
    flagImage.style.backgroundImage = "url('flag_en.png')";  // Set English flag image
  } else if (lang === 'fr') {
    flagImage.style.backgroundImage = "url('flag_fr.png')";  // Set French flag image
  } else if (lang === 'ar') {
    flagImage.style.backgroundImage = "url('flag_ar.png')";  // Set Arabic flag image
  }
}
